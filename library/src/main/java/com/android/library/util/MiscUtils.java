...
public class MiscUtils {
    ...
    public static final String APP_FOLDER_ON_SD =
            Environment.getExternalStorageDirectory().getAbsolutePath() +
                    "/DaoYi";
    public final static String APPINSTALLTIONID = "APPINSTALLTIONID";
    ...
    public static String getInstalltionID(Context context){
        String installID = PreferencesUtils.getString(context, APPINSTALLTIONID, "");
        if(TextUtils.isEmpty(installID)){
            installID = UUID.randomUUID().toString();
            PreferencesUtils.putString(context, APPINSTALLTIONID, installID);
        }
        return  installID;
    }
