...
public class DateUtil {
    ...
    public static String smtp2Str(String smtp, String format) {// yyyy-MM-dd HH:mm:ss
        if (TextUtils.equals(ObjectUtils.nullStrToEmpty(smtp), "")) {
            return "";
        }
        Date d = null;
        if(smtp.length() == 13){
            d = new Date(ConvertUtils.toLong(smtp));
        }
        if (d == null) {
            return null;
        }
