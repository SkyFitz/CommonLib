...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration
{
    ...
    public DividerGridItemDecoration(Context context, View ItemDecorationView) {
        ...
        if(ItemDecorationView == null || ItemDecorationView.getLayoutParams() == null){
            ...
            ItemDecorationView.setLayoutParams(new ViewGroup.LayoutParams(1,1));
            ItemDecorationView.setBackgroundColor(context.getResources().getColor(R.color.color_f3f6fd));
        }
